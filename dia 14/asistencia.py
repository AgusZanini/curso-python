...
# tomamos una foto con la camara web
...
if not exito:
    ...
    # codificar cara
    cara_codificada = fr.face_encodings(imagen, cara_captura)

    # buscar coincidencias
    for cara_codif, cara_ubic in zip(cara_codificada, cara_captura):
        ...
        # guardamos el indice en el que se encuentra la coincidencia en la lista
        indice_coincidencia = numpy.argmin(distancias)

        # mostrar coincidencias si las hay
        if distancias[indice_coincidencia] > 0.6:
            print("No coincide con nadie")
        else:
            ...
            cv2.putText(imagen,
                        f"{coincidencias[indice_coincidencia]} {distancias[indice_coincidencia].round(2)}",  # que voy a mostrar
                        (25, 25),  # ubicacion
